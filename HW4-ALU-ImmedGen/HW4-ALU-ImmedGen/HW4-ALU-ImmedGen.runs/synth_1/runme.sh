...
HD_PWD='Z:/Documents/git/CPE-233-Otter/HW4-ALU-ImmedGen/HW4-ALU-ImmedGen/HW4-ALU-ImmedGen.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ImmdGen.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ImmdGen.tcl
