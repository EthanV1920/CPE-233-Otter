...
REM
REM Generated by Vivado on Sat Feb 03 01:59:12 -0800 2024
...
echo "xvlog --incr --relax -L uvm -prj ImmdGen_TB_vlog.prj"
call xvlog  --incr --relax -L uvm -prj ImmdGen_TB_vlog.prj -log xvlog.log
