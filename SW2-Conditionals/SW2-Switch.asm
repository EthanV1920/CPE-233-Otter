	...
	li   x8, 4095		# value to add if !multiple of 4 and odd

	or   x9, x5, x6 	# or with x6 value to check for multiple of 4
	beq  x9, x6, isMultiple	# true if x5 is multiple of 4
	or   x9, x5, x7		# or with x7 value to theck 
	bne  x9, x7, isOdd	# true if x5 is odd
	
	addi  x5, x5, -1 	# subtract 1 from !odd and !multiple of 4
	j    end
			
isMultiple:
	not  x5, x5		# store not of swtiches
	j    end
isOdd:
	add  x5, x5, x8
