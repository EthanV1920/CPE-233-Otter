...
REM
REM Generated by Vivado on Wed Mar 13 14:16:15 -0700 2024
...
echo "xvlog --incr --relax -L uvm -prj MCU_TB_vlog.prj"
call xvlog  --incr --relax -L uvm -prj MCU_TB_vlog.prj -log xvlog.log
