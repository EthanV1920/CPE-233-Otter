...
HD_PWD='Z:/Documents/git/CPE-233-Otter/HW2-ProgramCounter/ProgramCounter/ProgramCounter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ProgramCounterEnv.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ProgramCounterEnv.tcl
