...
HD_PWD='Z:/Documents/git/CPE-233-Otter/HW5-BranchingHardware/BranchingHardware/BranchingHardware.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BranchConditionGen.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BranchConditionGen.tcl
