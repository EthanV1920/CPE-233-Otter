...
(define-fun |BranchConditionGen#2| ((state |BranchConditionGen_s|)) Bool (bvult (|BranchConditionGen#1| state) (|BranchConditionGen#0| state))) ; $lt$BranchConditionGen.sv:38$19_Y
...
(define-fun |BranchConditionGen#4| ((state |BranchConditionGen_s|)) Bool (bvslt (|BranchConditionGen#1| state) (|BranchConditionGen#0| state))) ; $lt$BranchConditionGen.sv:35$17_Y
...
(define-fun |BranchConditionGen#6| ((state |BranchConditionGen_s|)) Bool (= (|BranchConditionGen#1| state) (|BranchConditionGen#0| state))) ; $eq$BranchConditionGen.sv:31$15_Y
...
(define-fun |BranchConditionGenFormal#5| ((state |BranchConditionGenFormal_s|)) Bool (and (or  (|BranchConditionGenFormal#2| state) false) (or  (|BranchConditionGenFormal#3| state) false))) ; $logic_and$BranchConditionGenFormal.sv:56$14_Y
; yosys-smt2-cover 0 $cover$BranchConditionGenFormal.sv:54$11 BranchConditionGenFormal.sv:54.8-56.51
(define-fun |BranchConditionGenFormal_c 0| ((state |BranchConditionGenFormal_s|)) Bool (and (|BranchConditionGenFormal#5| state) true)) ; $cover$BranchConditionGenFormal.sv:54$11
(define-fun |BranchConditionGenFormal#6| ((state |BranchConditionGenFormal_s|)) Bool (bvult (|BranchConditionGenFormal#1| state) (|BranchConditionGenFormal#0| state))) ; $lt$BranchConditionGenFormal.sv:52$8_Y
(define-fun |BranchConditionGenFormal#7| ((state |BranchConditionGenFormal_s|)) (_ BitVec 1) (ite (|BranchConditionGenFormal#6| state) #b1 #b0)) ; $assert$BranchConditionGenFormal.sv:52$9_EN
; yosys-smt2-assert 0 $assert$BranchConditionGenFormal.sv:52$9 BranchConditionGenFormal.sv:52.39-53.39
(define-fun |BranchConditionGenFormal_a 0| ((state |BranchConditionGenFormal_s|)) Bool (or (|BranchConditionGenFormal#2| state) (not (= ((_ extract 0 0) (|BranchConditionGenFormal#7| state)) #b1)))) ; $assert$BranchConditionGenFormal.sv:52$9
(define-fun |BranchConditionGenFormal#8| ((state |BranchConditionGenFormal_s|)) Bool (bvslt (|BranchConditionGenFormal#1| state) (|BranchConditionGenFormal#0| state))) ; $lt$BranchConditionGenFormal.sv:47$5_Y
(define-fun |BranchConditionGenFormal#9| ((state |BranchConditionGenFormal_s|)) (_ BitVec 1) (ite (|BranchConditionGenFormal#8| state) #b1 #b0)) ; $assert$BranchConditionGenFormal.sv:47$6_EN
; yosys-smt2-assert 1 $assert$BranchConditionGenFormal.sv:47$6 BranchConditionGenFormal.sv:47.57-48.31
(define-fun |BranchConditionGenFormal_a 1| ((state |BranchConditionGenFormal_s|)) Bool (or (|BranchConditionGenFormal#3| state) (not (= ((_ extract 0 0) (|BranchConditionGenFormal#9| state)) #b1)))) ; $assert$BranchConditionGenFormal.sv:47$6
(define-fun |BranchConditionGenFormal#10| ((state |BranchConditionGenFormal_s|)) Bool (= (|BranchConditionGenFormal#0| state) (|BranchConditionGenFormal#1| state))) ; $eq$BranchConditionGenFormal.sv:42$2_Y
(define-fun |BranchConditionGenFormal#11| ((state |BranchConditionGenFormal_s|)) (_ BitVec 1) (ite (|BranchConditionGenFormal#10| state) #b1 #b0)) ; $assert$BranchConditionGenFormal.sv:42$3_EN
; yosys-smt2-assert 2 $assert$BranchConditionGenFormal.sv:42$3 BranchConditionGenFormal.sv:42.40-43.30
(define-fun |BranchConditionGenFormal_a 2| ((state |BranchConditionGenFormal_s|)) Bool (or (|BranchConditionGenFormal#4| state) (not (= ((_ extract 0 0) (|BranchConditionGenFormal#11| state)) #b1)))) ; $assert$BranchConditionGenFormal.sv:42$3
