...
REM
REM Generated by Vivado on Fri Jan 12 22:43:22 -0800 2024
...
echo "xvlog --incr --relax -L uvm -prj ProgRom_TB_vlog.prj"
call xvlog  --incr --relax -L uvm -prj ProgRom_TB_vlog.prj -log xvlog.log
